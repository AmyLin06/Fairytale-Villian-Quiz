$("button").click(function(){
    ...
    if (answer1 === "power and wealth" && answer2 === "0") {
        $(".reveal").text("The Evil Stepmother from Cinderella");
        $(".Cinderella").show();
    }
    else if (answer1 === "power and wealth" && answer2 === "100") {
        $(".reveal").text("Maleficent from Sleeping Beauty");
        $(".Maleficent").show();
    }
    else if (answer1 === "manipulation and witchcraft" && answer2 === "0") {
        ...
        $(".reveal").text("PLEASE WRITE AN ACCEPTABLE ANSWER!");
    }
});
